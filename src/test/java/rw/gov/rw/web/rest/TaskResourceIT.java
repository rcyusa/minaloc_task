...
class TaskResourceIT {
    ...
    private static final Progress DEFAULT_PROGRESS = Progress.A;
    private static final Progress UPDATED_PROGRESS = Progress.B;
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.startDate(UPDATED_START_DATE).status(UPDATED_STATUS).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
