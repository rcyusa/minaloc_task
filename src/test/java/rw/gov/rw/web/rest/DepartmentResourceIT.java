...
import rw.gov.rw.repository.DepartmentRepository;
import rw.gov.rw.service.dto.DepartmentDTO;
import rw.gov.rw.service.mapper.DepartmentMapper;
...
class DepartmentResourceIT {
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().name(DEFAULT_NAME).createdAt(DEFAULT_CREATED_AT).updatedAt(DEFAULT_UPDATED_AT);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
        return department;
    }
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
