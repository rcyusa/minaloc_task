...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, rw.gov.rw.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, rw.gov.rw.repository.UserRepository.USERS_BY_EMAIL_CACHE);
