...
/**
 * REST controller for managing {@link rw.gov.rw.domain.TaskType}.
 */
@RestController
@RequestMapping("/api")
public class TaskTypeResource {
    ...
    public ResponseEntity<TaskTypeDTO> updateTaskType(
        ...
        TaskTypeDTO result = taskTypeService.update(taskTypeDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<TaskTypeDTO>> getAllTaskTypes(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
