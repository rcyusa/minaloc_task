...
public class TaskType implements Serializable {
    ...
    public TaskType createdAt(Instant createdAt) {
    ...
    public TaskType updatedAt(Instant updatedAt) {
    ...
    public void setTasks(Set<Task> tasks) {
        if (this.tasks != null) {
            this.tasks.forEach(i -> i.setTaskType(null));
        }
        if (tasks != null) {
            tasks.forEach(i -> i.setTaskType(this));
        }
        this.tasks = tasks;
    }
