...
describe('TaskType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'task-type', component: TaskTypeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.taskTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to taskTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTaskTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTaskTypeIdentifier).toHaveBeenCalledWith(entity);
