...
type RestOf<T extends IDepartment | NewDepartment> = Omit<T, 'createdAt' | 'updatedAt'> & {
...
export class DepartmentService {
  ...
  protected convertDateFromClient<T extends IDepartment | NewDepartment | PartialUpdateDepartment>(department: T): RestOf<T> {
    return {
      ...department,
      createdAt: department.createdAt?.toJSON() ?? null,
      updatedAt: department.updatedAt?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restDepartment: RestDepartment): IDepartment {
    return {
      ...restDepartment,
      createdAt: restDepartment.createdAt ? dayjs(restDepartment.createdAt) : undefined,
      updatedAt: restDepartment.updatedAt ? dayjs(restDepartment.updatedAt) : undefined,
    };
  }
